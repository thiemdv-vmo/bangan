                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select name="attribute_select[]" class="select-search" data-placeholder="Chọn">
                                            ...
                                            <option value="{{$v->id}}" @if(in_array($v->id, $gallery_attribute_ids)) selected @endif>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                        @else
                                        <input type="text" class="form-control" name="attribute[{{$val->id}}]" value="{!!(in_array($val->id, $gallery_attribute_ids))?$gallery_attribute[$val->id]:''!!}">
                                        @endif
                                    </div>
                                </div>
                                @endforeach
