...
{{--                        <li class="nav-item"><a href="" class="nav-link">Slide</a></li>--}}
                        ...
                        <li class="nav-item"><a href="" class="nav-link">Khối</a></li>
                        <li class="nav-item"><a href="" class="nav-link">Tùy chỉnh giao diện</a></li>--}}
                    </ul>
                </li>
                {{--<li class="nav-item nav-item-submenu">
                    <a href="#" class="nav-link"><i class="icon-bucket"></i> <span>Thi công</span></a>
                    <ul class="nav nav-group-sub" data-submenu-title="Thi công">
                        <li class="nav-item"><a href="" class="nav-link">Đơn vị thi công</a></li>
                        <li class="nav-item"><a href="" class="nav-link">Danh mục</a></li>
                        <li class="nav-item"><a href="" class="nav-link">Hạng mục</a></li>
