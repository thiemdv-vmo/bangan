...
class CategoryRepository extends AbstractRepository {
    ...
    public function readHomeGalleryCategory($limit = 5) {
        return $this->model->where('type', \App\Category::TYPE_GALLERY)->where('parent_id', \App\Category::CATEGORY_PRODUCT)->take($limit)->get();
    }
